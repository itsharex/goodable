...
export default function ServiceConnectionModal({ 
  ...
  const handleAliyunAction = async (action: string) => {
    // Aliyun deployment is handled in ServiceSettings, not here
    // This modal is only for token configuration
    return;
  };
    ...
    switch (provider) {
      ...
      case 'aliyun':
        return {
          ...
          actions: [] // Deployment is handled in ServiceSettings, not here
        };
    }
  };
              ...
              <div className="space-y-4">
                ...
                {projectId && (
                  <div className="space-y-2">
                    ...
                    {/* Aliyun deployment is handled in ServiceSettings deploy page, not here */}
                  </div>
                )}
